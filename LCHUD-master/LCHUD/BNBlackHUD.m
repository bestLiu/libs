...
#import "BNBlackHUD.h"
#define kMessageFont [UIFont systemFontOfSize:12];
...
+ (UILabel *)initBlackLabel
{
    ...
    blackLabel.layer.cornerRadius = 4;
    blackLabel.layer.masksToBounds = YES;
    return blackLabel;
}
...
+ (void)showMessage:(NSString *)msg toView:(UIView *)aView
{
    ...
    NSInteger margin = 0;
    CGFloat theWidth = [self getStringWithString:msg];
